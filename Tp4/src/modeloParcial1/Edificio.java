...
public class Edificio {
	...
	/**
	 * Setea el argumento direccion seg�n el par�metro brindado.
	 * @param direccion
	 */
	...
	/**
	 * Setea el argumento cantDepartamentos seg�n el par�metro brindado.
	 * @param cantDepartamentos
	 */
	...
	/**
	 * Retorna la capacidad m�xima de unidades que puede albergar el edificio.
	 * @return
	 */
	...
	/**
	 * Itera la lista de departamentos para verificar que el numero de unidad no est� repetido, retorna true o false si la unidad existe.
	 * @param depto
	 * @return
	 */
	...
	public Departamento buscarPorUnidad(int unidad) {
		...
		while (i < departamentos.size() && depto == null) {
			if (departamentos.get(i).getNumeroUnidad() == unidad) {
				...
				i = i+1;
				System.out.println("No se encontr� la unidad brindada.");
			}
		}
		return depto;
	}
